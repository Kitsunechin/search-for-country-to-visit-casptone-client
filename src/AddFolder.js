...
export default class AddFolder extends React.Component{
    ...
    state = {
        ...
        name: '',
        errors: {
			name: 'You have to enter a note title'
        }
    }
    ...
    handleSubmit = (e) => {
        ...
        fetch(config.API_FOLDERS, {
            method: 'POST',
            body: JSON.stringify(this.context.folder),
            headers: {
            ...
            .then(data => {
                this.state.name.value = ''; ///wczesniej bylo name.value
        ...
        return (
            <form className="addFolderForm" onSubmit={e => this.handleSubmit(e)}>
                    ...
                    <input
                        ...
                        name="name"
                        id="name"
                        aria-label="name for the folder"
